...
export class MobileAppDesign extends Component {
	...
	handleResize() {
		if (this.chartRef.current) {
			// Assuming ReactApexChart does not support refs or resizing directly
			// Handle chart resize logic if supported or necessary
	...
	constructor(props) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["var(--primary-color)", "rgb(98, 89, 202)"],
				plotOptions: {
					bar: {
						columnWidth: '15%',
						borderRadius: 5,
...
const checked = <input className="form-check-input me-4 rounded" type="checkbox" value="" id="checkebox-sm" />
const defaultChecked = <input className="form-check-input me-4 rounded" type="checkbox" value="" id="checkebox-sm" defaultChecked />
export const TASKS = [
	{
