...
// async function ProjectReviewPostDetail({ params }) {
...
//             </li>
//             <li>
//               <Link href="/project_review" title="Listicle">
//               Project Review
//               </Link>
//             </li>
...
//   try {
//     const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/project_preview/${id}`, {
...
// export default ProjectReviewPostDetail;


// app/project_review/[slug]/[id]/page.js
import { notFound } from 'next/navigation';
import Link from 'next/link';
import Image from 'next/image';
