...
const Content = () => { 
    ...
    const fetchPosts = useCallback(async () => {
        try {
            const config = {
                method: 'get',
                url: `${process.env.NEXT_PUBLIC_API_URL}/api/admin/content`,
            };
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/content/${postToDelete.id}`);
    ...
    const handleActiveConfirm = async () => {
        ...
        try {
            await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/content/active/${activePost.id}`);
