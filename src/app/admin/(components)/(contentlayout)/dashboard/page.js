            ...
            <Col sm={12} lg={12} xl={12}>
              <Card className="custom-card overflow-hidden">
                <Card.Header className="border-bottom-0">
                  <div>
                    <label className="card-title">Project Budget</label>
                    <span className="d-block fs-12 mb-0 text-muted">
              ...
              <Card className="custom-card top-inquiries">
                ...
                <Card.Body>
                  ...
                  <Row className="mt-4">
                    ...
                    <Col className="col-3 my-auto">
                      <ProgressBar className=" ht-6 my-auto" now={70} />
                    </Col>
                    <Col className="col-4">
                      <div className="d-flex">
                        <span className="fs-13">
                  ...
                  <Row className=" mt-4">
                    ...
                    <Col className="col-3 my-auto">
                      <ProgressBar className=" ht-6 my-auto" now={50} />
                    </Col>
                    <Col className="col-4">
                      <div className="d-flex">
                        <span className="fs-13">
                  ...
                  <Card.Header className="border-bottom-0 pt-0 ps-0 pe-0 pb-2 d-flex">
                    ...
                    <div className="ms-auto d-flex flex-wrap gap-2">
                      ...
                      <Dropdown className="ms-auto d-flex">
                        ...
                        >
                          <i className="ri-equalizer-line me-1" />Sort by
                        </Dropdown.Toggle>
                  ...
                  <div className="table-responsive tasks">
                    <Table className="card-table table-vcenter text-nowrap mb-0 border dashboard-table">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th className="wd-lg-10p">Coin</th>
                          <th className="wd-lg-20p text-center">Name</th>
                          <th className="wd-lg-20p text-center">Stage</th>
                        ...
                        {TASKS.map((items, index) =>
                          <tr key={index} data-index={index}>
                            ...
                            <td className="text-nowrap">
                              <div className=" avatar-rounded avatar-sm">
                                <img
                                  alt="avatar"
                ...
                <tr>
                  ...
                  <td className="text-end">
                    <div className="d-inline-block">
                      <h6 className="mb-2 fs-15 fw-semibold">
                        $23.452
                        <i className="fas fa-level-down-alt ms-2 text-danger m-l-10" />
                      </h6>
