...
const CryptoCoins = () => {
    ...
    const fetchdataIco_Project_Type = async () => {
        try {
            const response = await axios.get('/api/admin/ico_project_type');
                    ...
                    <Card className="custom-card">
                        <Card.Header className="border-bottom-0 pb-0">
                            <div className="d-flex justify-content-between align-items-center w-100">
                                <label className="main-content-label my-auto mb-2">ICO Project Type</label>
