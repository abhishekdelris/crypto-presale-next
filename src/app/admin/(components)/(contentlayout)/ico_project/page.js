...
const CryptoCoins = () => {
    ...
    const fetchdata_ico_projects = async ()=>{
        try {
            ...
            console.log("data is not fetch ",error.message);
        }
    };

    useEffect(()=>{
        fetchdata_ico_projects();
    },[]);
                    ...
                    <Card className="custom-card">
                        <Card.Header className="border-bottom-0 pb-0">
                            <div className="d-flex justify-content-between align-items-center w-100">
                                <label className="main-content-label my-auto mb-2">ICO Project</label>
