																...
																<div className="mb-3 mb-xl-0">
																	<div className="main-profile-social-list">
																		<div className="media">
																			...
																			<div className="media-body"> <span>Github</span> <Link  scroll={false} href="#!">github.com/spruko</Link> </div>
																		</div>
																	</div>
																</div>
																<div className="ms-0 ms-xl-3 mb-3 mb-xl-0">
																	<div className="main-profile-social-list">
																		<div className="media">
																			...
																			<div className="media-body"> <span>Twitter</span> <Link  scroll={false} href="#!">twitter.com/spruko.me</Link> </div>
																		</div>
																	</div>
																</div>
																<div className="ms-0 ms-xl-3 mb-3 mb-xl-0">
																	<div className="main-profile-social-list">
																		<div className="media">
																			...
																			<div className="media-body"> <span>Linkedin</span> <Link  scroll={false} href="#!">linkedin.com/in/spruko</Link> </div>
																		</div>
																	</div>
																</div>
																<div className="ms-0 ms-xl-3 mb-3 mb-xl-0">
																	<div className="main-profile-social-list">
																		<div className="media">
																			...
																			<div className="media-body"> <span>My Portfolio</span> <Link  scroll={false} href="#!">spruko.com/</Link> </div>
																		</div>
																	</div>
																</div>
															</div>
															...
															<div className="media mg-t-15 profile-footer">
																<div className="media-user me-2">
																	<div className="avatar-list-stacked">
																		...
																		<Link scroll={false} className="avatar avatar-sm bg-primary avatar-rounded text-fixed-white" href="#!">+8</Link>
																	</div>
																...
																<div className="ms-auto mt-1 mt-sm-0">
																	<div className="dropdown show">
																		<Link scroll={false} className="new" href="#!"><i className="far fa-heart me-3"></i></Link>
																		<Link scroll={false} className="new" href="#!"><i className="far fa-comment me-3"></i></Link>
																		<Link scroll={false} className="new" href="#!"><i className="far fa-share-square"></i></Link>
																	</div>
																</div>
															</div>
														</div>
														...
														<div className="card-body h-100">
															...
															<div className="media mg-t-15 profile-footer">
																...
																<div className="ms-auto mt-1 mt-sm-0">
																	...
																	<Link scroll={false} className="new" href="#!"><i className="far fa-heart me-3"></i></Link>
																	 <Link scroll={false} className="new" href="#!"><i className="far fa-comment me-3"></i></Link> 
																	 <Link  scroll={false} className="new" href="#!"><i className="far fa-share-square"></i></Link> </div>
																</div>
															</div>
														</div>
													</div>
									...
									<Card.Body className="border">
										<Row>
											<Col lg={3} md={3} sm={6} col={12}>
												<Link  scroll={false} href="#!" className="glightbox card" onClick={() => setOpen(true)}><img src={"../../assets/images/media/media-4.jpg"} alt="image" /></Link>
											</Col>
											<Col lg={3} md={3} sm={6} col={12}>
												<Link  scroll={false} href="#!" className="glightbox card" onClick={() => setOpen(true)}><img src={"../../assets/images/media/media-5.jpg"} alt="image" /></Link>
											</Col>
											<Col lg={3} md={3} sm={6} col={12}>
												<Link  scroll={false} href="#!" className="glightbox card" onClick={() => setOpen(true)}> <img src={"../../assets/images/media/media-8.jpg"} alt="image" /></Link>
											</Col>
											<Col lg={3} md={3} sm={6} col={12}>
												<Link  scroll={false} href="#!" className="glightbox card" onClick={() => setOpen(true)}><img src={"../../assets/images/media/media-9.jpg"} alt="image" /></Link>
											</Col>
											<Col lg={3} md={3} sm={6} col={12}>
												<Link  scroll={false} href="#!" className="glightbox card" onClick={() => setOpen(true)}><img src={"../../assets/images/media/media-12.jpg"} alt="image" /></Link>
											</Col>
											<Col lg={3} md={3} sm={6} col={12}>
												<Link  scroll={false} href="#!" className="glightbox card" onClick={() => setOpen(true)}><img src={"../../assets/images/media/media-17.jpg"} alt="image" /></Link>
											</Col>
											<Col lg={3} md={3} sm={6} col={12}>
												<Link  scroll={false} href="#!" className="glightbox card" onClick={() => setOpen(true)}><img src={"../../assets/images/media/media-17.jpg"} alt="image" /></Link>
											</Col>
												...
												<Card className="custom-card border p-2">
													<div className=" text-center card-body">
														<div className="user-lock text-center">
															...
															<Link  scroll={false} href="#!"> <img alt="avatar" className="rounded-circle" src={"../../assets/images/faces/4.jpg"} /> </Link>
														</div>
														<Link  scroll={false} href="#!"> <h6 className=" mb-1 mt-3 main-content-label"> Socrates Itumay </h6> </Link>
												...
												<Card className="custom-card border p-2">
													<div className=" text-center card-body">
														<div className="user-lock text-center">
															...
															<Link  scroll={false} href="#!"> <img alt="avatar" className="rounded-circle" src={"../../assets/images/faces/3.jpg"} /> </Link>
														</div>
														<Link  scroll={false} href="#!"> <h6 className="mb-1 mt-3  main-content-label"> Reynante Labares </h6> </Link>
											...
											<Col sm={12} md={6} lg={6} xl={3}>
												<Card className="custom-card border p-2">
													<div className=" text-center card-body">
														...
														<Link  scroll={false} href="#!"> <h6 className="mb-1 mt-3 main-content-label"> Owen Bongcaras </h6> </Link>
													...
													<div className=" text-center card-body">
														<div className="text-center">
															<div className="user-lock text-center">
																...
																<Link  scroll={false} href="#!"> <img alt="avatar" className="rounded-circle" src={"../../assets/images/faces/7.jpg"} /> </Link>
															</div>
															<Link  scroll={false} href="#!"> <h6 className="mb-1 mt-3 main-content-label"> Stephen Metcalfe </h6> </Link>
												...
												<Card className="custom-card border p-2">
													<div className=" text-center card-body">
														<div className="user-lock text-center">
															...
															<Link  scroll={false} href="#!"> <img alt="avatar" className="rounded-circle" src={"../../assets/images/faces/2.jpg"} /> </Link>
														</div>
														<Link  scroll={false} href="#!"> <h6 className=" mb-1 mt-3 main-content-label"> Socrates Itumay </h6> </Link>
														<p className="mb-2 mt-1"> Project Manager </p>
														<p className="text-muted text-center mt-1">
												...
												<Card className="custom-card border p-2">
													<div className=" text-center card-body">
														<div className="user-lock text-center">
															...
															<Link  scroll={false} href="#!"> <img className="rounded-circle" src={"../../assets/images/faces/1.jpg"} alt="img" /> </Link>
														</div>
														<Link  scroll={false} href="#!"> <h6 className="mb-1 mt-3  main-content-label"> Reynante Labares </h6> </Link>
														<p className="mb-2 mt-1"> Web Designer </p>
														<p className="text-muted text-center mt-1">
												...
												<Card className="custom-card border p-2">
													<div className=" text-center card-body">
														<div className="user-lock text-center">
															...
															<Link  scroll={false} href="#!"> <img alt="avatar" className="rounded-circle" src={"../../assets/images/faces/9.jpg"} /> </Link>
														</div>
														<Link  scroll={false} href="#!"> <h6 className="mb-1 mt-3 main-content-label"> Stephen Metcalfe </h6> </Link>
														<p className="mb-2 mt-1"> Administrator </p>
														<p className="text-muted text-center mt-1">
											...
											<Form className="form-horizontal" data-select2-id="11">
												...
												<Form.Group className='my-2'>
													<Row className="row-sm">
														...
														<Col md={10}>
															<Link  scroll={false} href="#!" className=""> Set up Verification </Link>
														</Col>
													</Row>
												</Form.Group>
												<Form.Group className='my-2'>
												...
												<Form.Group className='my-2'>
													<Row className=" row-sm">
														...
														<Col md={10} className="d-inline-flex">
															<Link  scroll={false} href="#!" className="me-4"> Deactivate Account </Link>
															<Link  scroll={false} href="#!" className="mx-2"> Change Password </Link>
														</Col>
													</Row>
												</Form.Group>
											</Form>
