...
if (body.details && Array.isArray(body.details)) {
  ...
  for (const detail of body.details) {
    await prisma.crypto_coins_icos_details.create({
      data: {
        ...
        detail_ico_ido_type: parseInt(detail.detail_ico_ido_type) || null, 
        ...
        detail_is_review: detail.detail_is_review || null,
  ...
  await prisma.crypto_coins_icos_details.update({
    ...
    data: {
      ...
      detail_ico_ido_type: parseInt(body.detail_ico_ido_type) || null,
      detail_is_review: body.detail_is_review || null,
