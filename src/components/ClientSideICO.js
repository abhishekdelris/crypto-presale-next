...
//                     </div>
//                   </td>
//                   <td>{ico.ico_ido_type === 0 ? "ICO" : "presale"}</td>
//                   <td>
...
//                   No ICO data available for the selected filters
//                 </td>
//               </tr>
//             )}
//           </tbody>
...
export default function ClientSideICO({ initialData }) {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      params.append('ico_ido_type', '0'); // ICO type
                ...
                <tr key={ico.id || index}>
                  ...
                  <td>
                    <span
                      ...
                      className="custom-tooltip"
                    >
                      {calculateSingleDateDifference(ico.start_time, ico.end_time)}
                    </span>
                  </td>
