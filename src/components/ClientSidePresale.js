...
// const filteredPosts = setSelectedOption
// ? icoData.filter(post =>
//   icoData?.title?.toLowerCase().includes(searchQuery.toLowerCase()) ||
//   icoData?.author?.toLowerCase().includes(searchQuery.toLowerCase())
//   )
// : icoData;
...
// export default function ClientSideICO({ icoData }) {
//   const [selectedType, setSelectedType] = useState(''); // Changed from selectedOption
//   const [searchQuery, setSearchQuery] = useState("");
//   const router = useRouter();
//   const [visibleData, setVisibleData] = useState(15);
//   const [dateRange, setDateRange] = useState([null, null]);
