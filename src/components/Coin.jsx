            ...
            <div className="filtertable">
              ...
              <div className="filterblock">
                ...
                <div className="dropdown" onClick={(e) => e.stopPropagation()}>
                  ...
                  >
                    {filters.chain.length > 0 ? `${filters.chain.length} Selected` : 'All Chains'}
                  </button>
                  {openDropdowns.chain && (
                      ...
                      <li className="dropdown-item">
                        <div className="form-check">
                          <input 
                            ...
                            onChange={() => handleCheckboxChange('chain', 'Ethereum')}
                          />
                      ...
                      <li className="dropdown-item">
                        <div className="form-check">
                          <input 
                            ...
                            type="checkbox" 
                            id="chain2" 
                            checked={filters.chain.includes('Binance Smart Chain')}
                            onChange={() => handleCheckboxChange('chain', 'Binance Smart Chain')}
                          />
                      ...
                      <li className="dropdown-item">
                        <div className="form-check">
                          <input 
                            ...
                            onChange={() => handleCheckboxChange('chain', 'Solana')}
                          />
              ...
              <div className="filterblock">
                ...
                <div className="dropdown" onClick={(e) => e.stopPropagation()}>
                  ...
                  >
                    {filters.platform.length > 0 ? `${filters.platform.length} Selected` : 'All Platforms'}
                  </button>
                      ...
                      <li className="dropdown-item">
                        <div className="form-check">
                          <input 
                            ...
                            onChange={() => handleCheckboxChange('platform', 'PinkSale')}
                          />
                      ...
                      <li className="dropdown-item">
                        <div className="form-check">
                          <input 
                            ...
                            onChange={() => handleCheckboxChange('platform', 'DxSale')}
                          />
                      ...
                      <li className="dropdown-item">
                        <div className="form-check">
                          <input 
                            ...
                            onChange={() => handleCheckboxChange('platform', 'UniCrypt')}
                          />
            ...
            <div className="table_main">
              <div className="table-responsive">
                <table className="table table-bg table-striped table-manage">
                  ...
                  <tbody>
                    {
                      filteredData.length > 0 ? filteredData.map((coin, index) => (
                        ...
                        <tr>
                          <td colSpan="7" className="text-center">No data available for selected filters</td>
                        </tr>
                      )
                    }
                  </tbody> 
