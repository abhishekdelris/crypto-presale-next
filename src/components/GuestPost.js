...
//           <h5 className="h2 fw-bold mb-4">Guest Post</h5>
//         </div>
//       </div>
//       <div className="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-xl-4 row-cols-xxl-5">
//         <div className="col">
...
// import defaultBlogImage from "../images/blog.webp";
// import truncate from 'html-truncate';


// // Custom hook for read more functionality
// const useReadMore = (content, maxLength = 150) => {
...
//                 return (
//                 <div className="card" key={post.id} onClick={() => navigateToPost(post)}>
//                   <Image
