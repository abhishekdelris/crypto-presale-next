  ...
  useEffect(() => {
    if (post && slug) {
      ...
      if (correctSlug !== slug) {
        ...
        router.replace(`/listicle/${correctSlug}/${id}`, undefined, { shallow: true });
      }
    }
  }, [post, slug, id, router]);
      ...
      <section className="brdcrumb">
        <div className="container">
          <ul className="mb-0">
            ...
            <li>
              <Link href="/listicle" title="listicle">Listicle</Link>
            </li>
            <li>{post.title}</li>
          </ul>
        </div>
