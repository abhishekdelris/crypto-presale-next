...
// Separate function to handle the resend timer
...
useEffect(() => {
  ...
  const sendOTP = async () => {
    try {
      ...
      if (data.success) {
        ...
        // setOtpResendTimer(60); // Set resend timer to 60 seconds
        startResendTimer(); 
      } else {
 ...
 // Add these improved functions to your component
      ...
      <div className="modal-overlay">
        <div className="modal-content">
          <div className="modal-header">
            ...
            <button type="button" className="btn-close" onClick={() => setShowOtpModal(false)} disabled={verifyingOtp}></button>
          </div>
          <div className="modal-body">
            ...
            <div className="d-flex justify-content-between align-items-center mt-3">
              <button 
                ...
                onClick={sendOTP}
                disabled={otpResendTimer > 0 || verifyingOtp}
              >
